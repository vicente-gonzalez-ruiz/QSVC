...
#parametros1080px50
#parametros1080px25
VIDEO=coastguard_352x288x30x420x300.yuv
#VIDEO=CIF.yuv
slope=$1
...
# El mejor es:
busca_parametros 32 32 1 0 3 16 3


comentario(){
busca_parametros 32 32 4 0 3 16 1
busca_parametros 32 32 4 0 3 16 2
busca_parametros 32 32 4 0 3 16 3
busca_parametros 32 32 4 0 3 16 4
busca_parametros 32 32 4 0 3 16 5
busca_parametros 32 32 4 0 3 16 6
busca_parametros 32 32 4 0 3 16 7
busca_parametros 32 32 4 0 3 16 8
busca_parametros 32 32 4 0 3 16 9
}

comentario(){
busca_parametros 32 32 4 0 0 16
busca_parametros 32 32 4 0 1 16
busca_parametros 32 32 4 0 2 16

busca_parametros 32 32 4 1 0 16
busca_parametros 32 32 4 1 1 16
busca_parametros 32 32 4 1 2 16

busca_parametros 32 32 4 2 0 16
busca_parametros 32 32 4 2 1 16
busca_parametros 32 32 4 2 2 16
}

# 1, 2, 4, 8, 16, 32, 64	-[-s]earch_range=size of the searching area of the motion estimation (4)
