...
#parametros1080px50
#parametros1080px25
VIDEO=mobcal_1280x736x50x420x504.yuv
#VIDEO=720p.yuv
slope=$1
...
busca_parametros 32 32 6 0 1 2 1
busca_parametros 32 32 6 0 1 2 2
busca_parametros 32 32 6 0 1 2 3
busca_parametros 32 32 6 0 1 2 4
busca_parametros 32 32 6 0 1 2 5
busca_parametros 32 32 6 0 1 2 6
busca_parametros 32 32 6 0 1 2 7
busca_parametros 32 32 6 0 1 2 8
busca_parametros 32 32 6 0 1 2 9


comentario(){
busca_parametros 32 32 6 0 0 2
busca_parametros 32 32 6 0 1 2
busca_parametros 32 32 6 0 2 2

busca_parametros 32 32 6 1 0 2
busca_parametros 32 32 6 1 1 2
busca_parametros 32 32 6 1 2 2

busca_parametros 32 32 6 2 0 2
busca_parametros 32 32 6 2 1 2
busca_parametros 32 32 6 2 2 2
}
#busca_parametros 32 32 8 3 0 2
#busca_parametros 32 32 8 3 1 2
#busca_parametros 32 32 8 3 2 2
#busca_parametros 32 32 8 3 3 2


comentario(){ # $6=search_rang
busca_parametros 32 32 6 0 0 1
busca_parametros 32 32 6 0 0 2
busca_parametros 32 32 6 0 0 4
busca_parametros 32 32 6 0 0 8
busca_parametros 32 32 6 0 0 16
busca_parametros 32 32 6 0 0 32
busca_parametros 32 32 6 0 0 64
}
