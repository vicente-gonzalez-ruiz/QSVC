...
#parametros1080px25
parametros4096p
VIDEO=sun_4096x4096x30x420x129.yuv
slope=$1
...
busca_parametros () { # $1=IBS		$2=FBS		$3=TRL		$4=block_overlaping		$5=subpixel		$6=search_rang		$7=spatial_levels
	...
	echo -e "$slope \t$1 \t\t$2 \t\t$3 \t\t$4 \t\t$5 \t\t$6 \t\t$7 \t\t\tno \t\t\t$rate_mcj2k \t\t$fd_media_fftno \t$fd_media_fft2D \t$fd_media_fft3D \t\t$indice_FFTno" >> $VIDEO.FD$slope.dat
}
...
# El mejor es:
busca_parametros 1024 512 1 0 0 1 8


comentario(){
busca_parametros 1024 512 1 0 0 1 1
busca_parametros 1024 512 1 0 0 1 2
busca_parametros 1024 512 1 0 0 1 3
busca_parametros 1024 512 1 0 0 1 4
busca_parametros 1024 512 1 0 0 1 5
busca_parametros 1024 512 1 0 0 1 6
busca_parametros 1024 512 1 0 0 1 7
busca_parametros 1024 512 1 0 0 1 8
busca_parametros 1024 512 1 0 0 1 9


busca_parametros 1024 512 6 0 0 1
busca_parametros 1024 512 6 0 1 1

busca_parametros 1024 512 6 1 0 1
busca_parametros 1024 512 6 1 1 1

busca_parametros 1024 512 6 2 0 1
busca_parametros 1024 512 6 2 1 1
}


comentario(){ # $6=search_rang
busca_parametros 1024 512 6 0 0 1
busca_parametros 1024 512 6 0 0 2
busca_parametros 1024 512 6 0 0 4
}

comentario(){ # $1=IBS $2=FBS $3=TRL
busca_parametros 512 512 6 0 0 2
busca_parametros 512 512 5 0 0 2
busca_parametros 512 512 4 0 0 2
busca_parametros 512 512 1 0 0 2

busca_parametros 512 256 6 0 0 2
busca_parametros 512 256 5 0 0 2
busca_parametros 512 256 4 0 0 2
busca_parametros 512 256 1 0 0 2

busca_parametros 256 256 6 0 0 2
busca_parametros 256 256 5 0 0 2
busca_parametros 256 256 4 0 0 2
busca_parametros 256 256 1 0 0 2

busca_parametros 256 128 6 0 0 2
busca_parametros 256 128 5 0 0 2
busca_parametros 256 128 4 0 0 2
busca_parametros 256 128 1 0 0 2
	
busca_parametros 128 128 6 0 0 2
busca_parametros 128 128 5 0 0 2
busca_parametros 128 128 4 0 0 2
busca_parametros 128 128 1 0 0 2

busca_parametros 128 64 6 0 0 2
busca_parametros 128 64 5 0 0 2
busca_parametros 128 64 4 0 0 2
busca_parametros 128 64 1 0 0 2

busca_parametros 64 64 6 0 0 2
busca_parametros 64 64 5 0 0 2
busca_parametros 64 64 4 0 0 2
busca_parametros 64 64 1 0 0 2

busca_parametros 64 32 6 0 0 2
busca_parametros 64 32 5 0 0 2
busca_parametros 64 32 4 0 0 2
busca_parametros 64 32 1 0 0 2

busca_parametros 32 32 6 0 0 2
busca_parametros 32 32 5 0 0 2
busca_parametros 32 32 4 0 0 2
busca_parametros 32 32 1 0 0 2
}
