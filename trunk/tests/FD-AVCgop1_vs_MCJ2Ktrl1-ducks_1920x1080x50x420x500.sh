...
VIDEO=ducks_1920x1080x50x420x500.yuv
...
if [[ ! -e $DATA/$VIDEO.yuv ]]; then
    current_dir=$PWD
    cd $DATA
    wget http://media.xiph.org/video/derf/y4m/ducks_take_off_1080p50.y4m
    mencoder ducks_take_off_1080p50.y4m -ovc raw -of rawvideo -vf format=i420 -o $VIDEO.yuv
    cd $current_dir
fi
...
#slope=44632 rate_mcj2k=4764.28171206
#slope=44631 rate_mcj2k=4780.98054475
#rango=10
slope=44631
