...
carpeta="codestream_10/data-FD-MCJ2K-buscaRate_129-coastguard_352x288x30x420x300.sh_44000.32.32.4.0.3.16.3"
carpeta2="codestream_10/data-FD-MCJ2K-buscaRate_129-coastguard_352x288x30x420x300.sh_44000.32.32.1.0.3.16.3"
...
#		mkdir $base_dir/tmps/tmp.$slope_H1.$slope_H2.$slope_H3.$slope_H4.$slope_L ; cp *.mjc $base_dir/tmps/tmp.$slope_H1.$slope_H2.$slope_H3.$slope_H4.$slope_L
	...
	# expand
# !
		mcj2k expand --block_overlaping=0 --block_size=32 --block_size_min=32 --layers=10 --pictures=129 --temporal_levels=4 --pixels_in_x=352 --pixels_in_y=288 --subpixel_accuracy=3 --search_range=16
...
# !
		mcj2k compress --block_overlaping=0 --block_size=32 --block_size_min=32 --slopes=$slope_L --pictures=1 --temporal_levels=1 --pixels_in_x=352 --pixels_in_y=288 --subpixel_accuracy=3 --search_range=16 --spatial_levels=3
...
iteraciones=6
divisores=(0.999	0.998	0.997	0.996	0.995	0.994	0.993	0.992	0.991	0.99	0.9875	0.985	0.9825	0.98)
